<template>
  <div class="flex min-h-screen bg-ferchas-fondo">
      ...
      <main class="flex-1 p-8 overflow-y-auto">
        <div class="max-w-6xl mx-auto">
          <div class="flex justify-between items-center mb-8">
            <h1 class="font-titulo text-4xl text-ferchas-cafe">📦 Pedidos</h1>
          ...
          <div class="flex gap-3 mb-6">
            <button
              ...
              :class="[
                ...
                filtroEstado === null ? 'bg-ferchas-rosa text-white' : 'bg-white text-ferchas-cafe border-2 border-ferchas-rosa/30'
              ]"
            >
              Todos
            </button>
            <button
              ...
              :class="[
                'px-4 py-2 rounded-lg font-semibold transition-colors',
                filtroEstado === 'Pendiente' ? 'bg-ferchas-rosa text-white' : 'bg-white text-ferchas-cafe border-2 border-ferchas-rosa/30'
              ]"
            >
              Pendientes
            </button>
            <button
              ...
              :class="[
                'px-4 py-2 rounded-lg font-semibold transition-colors',
                filtroEstado === 'Preparando' ? 'bg-ferchas-rosa text-white' : 'bg-white text-ferchas-cafe border-2 border-ferchas-rosa/30'
              ]"
            >
              Preparando
            </button>
            <button
              ...
              :class="[
                'px-4 py-2 rounded-lg font-semibold transition-colors',
                filtroEstado === 'Entregado' ? 'bg-ferchas-rosa text-white' : 'bg-white text-ferchas-cafe border-2 border-ferchas-rosa/30'
              ]"
            >
              Entregados
            </button>
    ...
    <!-- Modal Nuevo Pedido -->
    <div v-if="mostrarModalNuevo" class="fixed inset-0 bg-black/50 flex items-center justify-center p-4 overflow-y-auto">
      <div class="bg-white rounded-lg shadow-lg max-w-2xl w-full my-8">
        <div class="p-6 border-b-2 border-ferchas-rosa/30">
          <h2 class="font-titulo text-2xl text-ferchas-cafe">Nuevo Pedido</h2>
        </div>
        <div class="p-6 space-y-4">
          <!-- Cliente -->
          <div>
            <label class="block text-sm font-semibold text-ferchas-cafe mb-2">Cliente</label>
            <input
          ...
          <!-- Tipo Pedido -->
          <div>
            <label class="block text-sm font-semibold text-ferchas-cafe mb-2">Tipo de Pedido</label>
          ...
          <!-- Método Pago -->
          <div>
            <label class="block text-sm font-semibold text-ferchas-cafe mb-2">Método de Pago</label>
