  ...
  <div class="min-h-screen bg-ferchas-fondo">
    ...
    <div class="flex">
      ...
      <main class="flex-1 p-8">
        <h1 class="font-titulo text-3xl font-bold text-ferchas-cafe mb-8">Dashboard</h1>

        <!-- Grid de Tarjetas de Resumen -->
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <!-- Ventas del Día -->
          <div class="card-base">
            <h3 class="text-sm font-semibold text-ferchas-cafe-claro uppercase mb-2">Ventas del Día</h3>
          ...
          <!-- Pedidos Pendientes -->
          <div class="card-base">
            <h3 class="text-sm font-semibold text-ferchas-cafe-claro uppercase mb-2">Pendientes</h3>
          ...
          <!-- Stock Bajo -->
          <div class="card-base">
            <h3 class="text-sm font-semibold text-ferchas-cafe-claro uppercase mb-2">Stock Bajo</h3>
          ...
          <div class="card-base">
            <h3 class="text-sm font-semibold text-ferchas-cafe-claro uppercase mb-2">Clientes</h3>
        ...
        <div v-if="productosStockBajo.length > 0" class="card-base mb-8">
          <h2 class="font-titulo text-xl text-ferchas-cafe mb-4">Productos con Stock Bajo</h2>
        ...
        <div v-if="pedidosPendientes.length > 0" class="card-base">
          <h2 class="font-titulo text-xl text-ferchas-cafe mb-4">Pedidos Pendientes</h2>
          <div class="overflow-x-auto">
            <table class="tabla-base w-full">
              <thead class="tabla-header">
                <tr>
